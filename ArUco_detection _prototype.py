...
circle_center2 = (c[:, 0].mean(), c[:, 1].mean())
circle_radius = circles[0, :][0][2]

cv2.circle(img_markers, circle_center2, circle_radius, (0, 255, 0), 2)
...
for n in range(int(circle_center2[1] - 9*circle_radius/16-1), int(circle_center2[1] - 7*circle_radius/16-1 )):
    for m in range(int(circle_center2[0] - 9*circle_radius/16-1), int(circle_center2[0] - 7*circle_radius/16-1 )):
